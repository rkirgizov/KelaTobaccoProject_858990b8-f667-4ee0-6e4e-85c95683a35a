...
MOD_SUBDIR_NAME="KelaTobaccoProject_858990b8-f667-4ee0-6e4e-85c95683a35a"
...
git remote set-url origin git@github.com:rkirgizov/KelaTobaccoProject_858990b8-f667-4ee0-6e4e-85c95683a35a.git
git add --all
